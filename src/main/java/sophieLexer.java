...
public class sophieLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "WS", "COMMENT", "NUMBER", "CURRENCY", "BUY", "SELL", "OF", "IF", 
			"PORTFOLIO", "IDENTIFIER", "SEMICOLON", "LPAR", "RPAR", "COMMA", "DOT", 
			"GT", "LT", "EQ", "NEQ", "AND", "OR", "PLUS", "MINUS", "MUL", "DIV"
		};
	}
	...
	public sophieLexer(CharStream input) {
		super(input);
